...
LAYER_NAME="lambda-telemetry-api-exporter"
...
pushd extensions/lambda-telemetry-api-exporter-ext
npm install
popd
...
do
    ...
    ARTIFACT_OBJECT="layers/$LAYER_NAME/$LAYER_NAME-$RELEASE_ID.zip"
